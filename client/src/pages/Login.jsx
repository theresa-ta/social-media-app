...
const Login = () => { /*created the whole thing here*/
    return (
        <div className='min-h-screen flex flex-col md:flex-row'>
            ...
            <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
                ...
                <div>
                    ...
                    <p className='text-xl mf:text-3cl text-indigo-900 max-w-72 md:max-w-md'>Connect with global community on pingup</p>
                </div>
                <span className='md:h-10' /*puts this in the middle*/ ></span> 
            </div>
        </div>
    )
}
